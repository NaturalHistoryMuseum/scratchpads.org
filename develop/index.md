...
The Scratchpad project is fully open source. If you're interested in assisting with the development of the Scratchpads, or you'd like to add some functionality, then download the code for local development and testing. All of our code currently resides on our own [Git server]({{ '/develop/repository' | relative_url }}), and we also have our own development site for development and testing of [Drupal modules](http://drupal.org/developing/modules).
